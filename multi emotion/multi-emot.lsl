...
doMindBlown()
{
    ...
    llParticleSystem([
        ...
        PSYS_SRC_BURST_SPEED_MIN, (float)0.2,
        PSYS_SRC_BURST_SPEED_MAX, (float)0.5,
        PSYS_PART_START_SCALE, (vector)<0.15, 0.15, 0>,
...
doHeartEyes()
{
    ...
    llParticleSystem([
        ...
        PSYS_SRC_ACCEL, (vector)<0, 0, 0.1>,
        PSYS_SRC_TEXTURE, TEX_HEARTEYES,
        PSYS_SRC_BURST_SPEED_MIN, (float)0.02,
        PSYS_SRC_BURST_SPEED_MAX, (float)0.08,
